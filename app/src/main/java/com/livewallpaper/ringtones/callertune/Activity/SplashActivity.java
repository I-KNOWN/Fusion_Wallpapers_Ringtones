...
public class SplashActivity extends AppCompatActivity {
    ...
    private void nextActivity() {
        startActivity(MyApplication.getPreferences().isFirstRun()? new Intent(SplashActivity.this, EditorActivity.class): new Intent(SplashActivity.this, MainActivity.class));
